...
const HughesFlap = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Hughes flap eyelid surgery Bangalore | Dr. Divya D Sundaresh</title>
                <meta name="description" content='Dr. Divya D Sundaresh offers Hughes flap eyelid surgery in Bangalore, Karnataka for lower eyelid reconstruction after tumor excision.' />
            </Helmet>
            <div>
