...
const CutlerBeardFlap = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Cutler-Beard eyelid surgery Bangalore | Dr. Divya D Sundaresh</title>
                <meta name="description" content='Dr. Divya D Sundaresh offers Cutler-Beard eyelid surgery in Bangalore, Karnataka for upper eyelid reconstruction after tumor removal.' />
            </Helmet>
            <div>
