...
const Tenzelsflap = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Tenzel’s flap eyelid surgery Bangalore | Dr. Divya D Sundaresh</title>
                <meta name="description" content='Dr. Divya D Sundaresh performs Tenzel’s flap eyelid surgery in Bangalore, Karnataka for eyelid reconstruction after tumor removal.' />
            </Helmet>
            <div>
                <Divyaservicebanner servicename='Tenzel Flap Surgery' />
            </div>
            ...
            <div className="lg:mx-20 md:mt-10 xs:mt-29 mx-5 mt-10">
                <div className="flex flex-col items-center">
                    ...
                    <div className="text-[18px] md:text-[20px] lg:text-[30px] font-[600] font-heading bg-orange-gradient mt-2">Reconstructive Eyelid Surgery for Functional & Aesthetic Restoration</div>
