...
const Dacryoplasty = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Dacryoplasty eye surgery in Bangalore | Dr. Divya D Sundaresh</title>
                <meta name="description" content='Dr. Divya D Sundaresh offers dacryoplasty eye surgery in Bangalore, Karnataka to treat tear duct blockages with minimally invasive care.' />
            </Helmet>
            <div>
