    ...
    <div className='mt-10'>
      <div className=' xl:flex justify-center items-center bg-[#FFF6E0] p-5 xl:py-10 xl:px-15 gap-10 lg:flex'>
        ...
        <div className='text-center' >
          <div className='xl:text-[30px] font-[600] bg-gradient-to-b from-[#EF7F1A] to-[#B22726] bg-clip-text text-transparent font-heading sm:text-[20px] xs:text-[18px]'>{contacts.heading}</div>
          <div className='xl:text-[16px] font-[500] font-para xl:text-sm/8 py-5 sm:text-[15px] xs:text-[12px] md:text-[14px] text-[12px]'>{contacts.para}</div>
        </div>
