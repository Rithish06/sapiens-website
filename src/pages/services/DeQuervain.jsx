...
const DeQuervain = () => {
  ...
  return (
    <div className=''>
      ...
      {/* <div className='bg-[#B6FEB433]'>
          <div className='flex items-center xl:text-[30px] sm:text-[20px] font-[600] gap-5 justify-center bg-gradient-to-b from-[#EF7F1A] to-[#B22726] bg-clip-text text-transparent font-heading'><img src={assets.faqicon} alt="" /><span>Frequently Asked Questions</span></div>
          <div className='text-[18px] font-[500] py-5' >
            <div><img  src={assets.faqPlus} alt="" /></div>
            <div>
              <div className='text-[18px] font-[500]'>{faqs.ques}</div>
              <div>{faqs.ans}</div>
            </div>
          </div>
