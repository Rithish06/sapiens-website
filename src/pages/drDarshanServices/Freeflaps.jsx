      ...
      return (
          <div>
              ...
              <div className='px-8 lg:px-20 mt-8'>
                  ...
                  <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                      <div>
                          <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>The procedure involves :</div>
                          ...
                          <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>The success of the surgery heavily relies on the patency of the vascular connections, necessitating meticulous technique and postoperative monitoring.</div>
                      </div>
              ...
              <div className='px-8 lg:px-20 mt-8'>
                  ...
                  <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                      <div>
                          ...
                          <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Recovery timelines vary depending on the complexity of the reconstruction and the patient's overall health.</div>
                      </div>
                  </div>
              </div>
