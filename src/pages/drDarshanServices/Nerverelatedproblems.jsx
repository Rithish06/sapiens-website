    ...
    return (
        <div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                <div className='text-[18px] font-[600] bg-orange-gradient font-heading lg:text-[30px]'>Nerve-Related Problems Affecting the Hand and Upper Limb in Bangalore</div>
