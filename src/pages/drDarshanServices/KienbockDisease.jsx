...
const KienbockDisease = () => {
    ...
    const faqs = [
        {
            ques: "Is Kienböck’s disease curable?",
            ans: "While there's no permanent cure, early diagnosis and proper treatment can control the disease and prevent joint destruction."
        },
        {
            ques: "Do I always need surgery for Kienböck’s disease?",
            ans: "Not always. Early stages can often be managed with non-surgical treatments. Surgery is typically recommended in more advanced stages."
        },
        {
            ques: "How long does it take to recover after surgery?",
            ans: "Recovery depends on the type of surgery performed. It may take several weeks to months, followed by physical therapy."
        },
        {
            ques: "Can the condition worsen without treatment?",
            ans: "Yes, untreated Kienböck’s disease can progress to severe wrist arthritis and long-term disability."
        },
        {
            ques: "Can I return to sports or work after treatment?",
            ans: "In most cases, yes—especially with early treatment and rehabilitation. Your doctor will guide you based on the type of treatment and your recovery progress."
        }
    ];
