    ...
    return (
        <div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                <div className='text-[18px] font-[600] bg-orange-gradient font-heading lg:text-[30px]'>Birth-Related Brachial Plexus Injury Treatment in Malleshwaram</div>
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Birth-related brachial plexus injuries (BRBPI) occur when the network of nerves transmitting signals from the spinal cord to the shoulder, arm, and hand is damaged during childbirth. At Sapiens Clinic in Malleshwaram, we specialize in diagnosing and treating BRBPI, aiming to restore function and improve quality of life for affected infants.</div>
                    </div>
                </div>

                <div className='text-[18px] font-[600] bg-orange-gradient font-heading lg:text-[30px]'>Understanding Birth-Related Brachial Plexus Injuries</div>
                <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>The brachial plexus is a bundle of nerves originating from the spinal cord in the neck, extending through the shoulder to the arm and hand. Injuries during birth can result from stretching, compression, or tearing of these nerves, leading to varying degrees of motor and sensory deficits.</div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className="font-para text-[12px] lg:text-[16px] leading-[26px] mt-3">BRBPI can result from:</div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className="font-para text-[12px] lg:text-[16px] leading-[26px] mt-3">Common signs of BRBPI include:</div>
                        <ul className='mt-5  list-disc pl-10'>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Prompt medical evaluation is essential for optimal recovery.</div>
                    </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>These assessments help determine the extent and location of the injury.</div>
                    </div>
                </div>
            </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Treatment depends on injury severity :</div>
                        <ul className='mt-5  list-disc pl-10'>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Early surgical intervention may improve outcomes.</div>
                    </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                <div className='text-[18px] font-[600] bg-orange-gradient font-heading lg:text-[30px]'>Recovery and Rehabilitations</div>
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4'>Birth-related brachial plexus injuries can significantly impact an infant's development and quality of life. At Sapiens Clinic, Malleshwaram, our multidisciplinary team is dedicated to providing comprehensive care, from accurate diagnosis to personalized treatment plans, ensuring optimal recovery and prevention of future complications.</div>
                    </div>
                </div>
            </div>
