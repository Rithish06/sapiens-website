        ...
        <div>
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>The hand is one of the most commonly injured parts of the body during sports activities. Whether it’s a fall on an outstretched hand, a misjudged catch, or repeated stress from high-impact movements, athletes and fitness enthusiasts are especially vulnerable to hand and wrist injuries. Ignoring these injuries or delaying treatment can lead to long-term damage and restricted hand function.</div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>At Sapiens Clinic in Malleshwaram, we provide specialized care for a wide range of sports-related hand injuries-from minor ligament sprains to complex fractures and tendon injuries.</div>
                    </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>These symptoms should not be ignored - especially if they worsen with activity or affect grip and function.</div>
                    </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>Diagnosis begins with a detailed physical examination. To assess the type and extent of injury, doctors may order:</div>
                        <ul className='mt-5  list-disc pl-10'>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>An accurate diagnosis helps guide effective treatment and prevents mismanagement that can delay healing.</div>
                    </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>Treatment is personalized depending on the severity and type of injury. Common approaches include:</div>
                        <ul className='mt-5  list-disc pl-10'>
                        ...
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>Rehabilitation is key to restoring full function and preventing reinjury-especially in active individuals and athletes.</div>
                    </div>
                </div>
            </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>Recovery time depends on the type and severity of injury. Minor sprains may heal within 2 to 4 weeks, while fractures or surgical cases may require several months of healing and rehabilitation. Returning to sports too soon can increase the risk of reinjury. At the clinic, we guide patients through a complete recovery plan and safe return-to-play protocols.</div>
                    </div>
                </div>
            </div>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                ...
                <div className='flex flex-column lg:flex-row gap-[20px] lg:gap-[50px]'>
                    <div>
                        <div className='font-para text-[12px] lg:text-[16px] leading-[26px] mt-4 font-[500]'>Sports-related hand injuries, while common, should never be overlooked. Prompt diagnosis and the right treatment make all the difference in regaining hand strength, function, and performance. Whether you're a recreational player or a professional athlete, your hands deserve expert care. For specialized treatment of hand injuries and sports trauma, consult <b>Dr. Darshan Kumar A.</b> Jain, Hand and Upper Limb Surgeon at Sapiens Clinic, Malleshwaram.</div>
                    </div>
                </div>
            </div>
