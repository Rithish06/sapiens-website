...
const Complexreconstructionrequiringbothsofttissueandbone = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Complex Limb Reconstruction in Bangalore | Dr. Darshan Kumar A Jain</title>
                <meta name='description' content='Dr. Darshan Kumar A Jain offers complex limb reconstruction involving soft tissue and bone in Bangalore, Karnataka. Restore function fully.' />
            </Helmet>
            ...
            <div className='px-8 lg:px-20 mt-8'>
                <div className='text-[18px] font-[600] bg-orange-gradient font-heading lg:text-[30px]'>Complex Reconstruction Requiring Both Soft Tissue and Bone in Bangalore</div>
