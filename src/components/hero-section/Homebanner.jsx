...
const HomeBanner = () => {
	...
	return (
		<div className="relative w-screen overflow-hidden">
				...
				>
					<div className="relative">
						...
						<div className="absolute inset-0 flex flex-col justify-start gap-2 lg:gap-1.5 mxl:gap-2 s:mt-[10%] px-2 md:px-5 lg:px-10 z-20 top-[10%] md:top-4 lg:top-[12%] mxl:top-[20%]">
							...
							<div className="flex gap-6 lg:mt-4 mxl:mt-6">
				...
				>
					<div className="relative">
						...
						<img
							...
							alt="Slide 2 Mobile"
						/>
						<div className="absolute inset-0 flex flex-col justify-start gap-3 px-2 md:px-7 z-20 top-[25%]">
							<div className="text-[16px] font-heading font-[700] s:text-[19px] md:text-[22px] text-white">
								Dr. Darshan Kumar A. Jain
							</div>
							<div className="text-[10px] font-heading font-[600] s:text-[12px] md:text-[16px] text-white">
								MBBS, MS, FNB, MNAMS, PGDHHM
							</div>
							<div className="font-para text-[8px] text-white w-[230px] s:w-[280px] md:w-[340px] s:text-[9px] md:text-[10.5px] mt-2">
								Dr. Darshan Kumar A. Jain is a highly experienced hand surgeon...
							</div>
							<div className="font-para text-[8px] text-white w-[230px] s:w-[280px] md:w-[340px] s:text-[9px] md:text-[10.5px] mt-2">
								As a board-certified Hand Surgery Specialist...
							</div>
							<div className="flex gap-6 mt-6 md:mt-3">
								<button className="bg-[#EF7F1A] px-3 py-2 text-[12px] rounded-sm text-white">
									Learn More
								</button>
								<button className="bg-white px-3 py-2 text-[12px] rounded-sm text-[#001F3F]">
									Contact Us
								</button>
							</div>
						</div>
			...
			<div className="absolute w-full left-1/2 -translate-x-1/2 flex gap-2 z-50 justify-end md:justify-center md:hidden"
				style={{
				...
				{[0, 1].map((i) => (
					<button
						key={i}
						onClick={() => showSlide(i)}
						className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === i ? "bg-yellow-500 scale-125" : "bg-white/50"
							}`}
					></button>
				))}
			</div>
